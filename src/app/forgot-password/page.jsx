...
const Signup = () => {
	...
	const resetEmail = (event) => {
		...
		sendPasswordResetEmail(event.email, email);
	};
		...
		<>
			<div className="w-full flex justify-around items-center">
				...
				<div className="h-fit w-full lg:w-3/4 xl:w-1/3 bg-[#22221f] rounded-2xl py-8 px-8 flex flex-col gap-y-5">
					<h2 className="text-center text-zinc-100 text-2xl">Haben Sie Passwort vergessen?</h2>
					<form onSubmit={resetEmail} className="flex flex-col items-center gap-y-8 font-light text-lg text-zinc-100">
						...
						<button disabled={!event.email} className={`bg-[#CC7503] text-[#F0FDF4] w-4/5 py-2 rounded-xl font-medium text-xl hover:scale-95 transition duration-200`} type="submit">
