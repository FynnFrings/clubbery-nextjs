		...
		<div className="flex flex-col md:flex-row md:justify-evenly md:items-center text-white  w-full">
			<div className="flex flex-col gap-y-5 w-full md:w-2/3">
				...
				<div className="flex flex-col md:flex-row gap-5">
					<Link target="_blank" href="https://apps.apple.com/de/app/clubbery/id6476625439">
						<Image src="/badges/apple-badge.png" alt="Laden in App Store" width={150} height={50} />{" "}
					</Link>
					<Link target="_blank" href="https://play.google.com/store/apps/details?id=net.swibble.clubberyApp">
			...
			<div className="hidden md:block relative">
				...
				<Image className="z-10" src="/iphonemockupsclubbery.png" alt="phone" width={1200} height={1500} />
			</div>
		</div>
	);
};
